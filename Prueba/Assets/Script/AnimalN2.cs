...
public class AnimalN2 : MonoBehaviour
{   public List<GameObject> animals;
    ...
    void Update()
    {
        if (ScoreBauraNiveldos.scorebasuratotalinfo >= 10)
        {
         ...
         if (ScoreBauraNiveldos.scorebasuratotalinfo > 20 )
        {
         ...
         if (ScoreBauraNiveldos.scorebasuratotalinfo > 30 )
        {
